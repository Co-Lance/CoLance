            ...
            <div class="py-16 px-7 rounded-md bg-white">
                ...
                <form class="" action="{{ route('contracts.store') }}" method="POST">
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
                        <input type="text" id="fname" name="contract_name" placeholder="Nom *"
                            class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700 ">
                        <input type="text" id="fname" name="contract_status" placeholder="Téléphone *"
                            class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700">
                        <input type="date" id="fname" name="contract_date" placeholder="Localisation *"
                            class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700">

                        <div class="md:col-span-2">
                            <label for="subject" class="float-left block  font-normal text-gray-400 text-lg">Vous
                                accompagner sur :</label>
                            <select id="subject" name="contract_type"
                                class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700">
                        ...
                        <div class="md:col-span-2">
                            <label for="subject" class="float-left block  font-normal text-gray-400 text-lg">Ajoutez une
                                image ou une pièce jointe de votre objet :</label>
                            <input type="file" id="file" name="file" placeholder="Charger votre fichier"
                        ...
                        <div class="md:col-span-2">
                            <textarea name="contract_description" rows="5" cols="" placeholder="Description*"
                ...
                <label for="" class="text-sm col-span-2">
                  Autoriser OC à vous envoyer des lettres d'information par E-mail.
                        ...
                        <div class="md:col-span-2">
                            <button
                                class="py-3 text-base font-medium rounded text-white bg-blue-800 w-full hover:bg-blue-700 transition duration-300">Valider</button>
                        </div>
                    </div><!-- Grid End -->
                </form>
            </div>
