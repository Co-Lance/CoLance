    ...
    <div class="flex flex-col lg:flex-row md:flex-row" style="background-color: #F6F6F6;">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-blue-300 w-52 h-72 m-8 static rounded-lg ">
                <div
                    class="bg-white w-52 h-72 -m-2 hover:m-0 absolute rounded-lg shadow-lg hover:shadow-2xl transition-all duration-150 ease-out hover:ease-in ">
                    ...
                    <a href="{{ route('contracts.edit', ['id' => $contract->id]) }}">
                        ...
                        <div class="btn btn-success ms-2 me-5"><i class="fa-solid fa-pen-to-square">Edit</i></div>
                    </a> <a href="{{ route('contracts.destroy', ['id' => $contract->id]) }}">
                        <div class="btn btn-danger">Delete<i class="fa-regular fa-trash-can"></i></div>
                    </a>
                </div>
            </div>
