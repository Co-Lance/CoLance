            ...
            <div class="flex gap-3 flex-wrap justify-center mt-5">
                ...
                <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow-lg">
                    <div class="rounded-t-lg w-full h-2/4">
                        <img src="{{ $inventory->image }}" alt="{{ $inventory->InventoryName }}" class="rounded-t-lg w-full h-full object-cover" />
                    </div>
                    <div class="flex flex-col p-5">
                        ...
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('inventories.edit', ['id' => $inventory->id]) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-red-500 border border-red-500 rounded-lg hover:bg-red-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300">
                                Modifier
            ...
            <div class="pr-16 mt-10">
                <div class="p-4">
                    <div id="menu" class="flex flex-col space-y-2">
                        ...
                        <a href="{{ url('/addinventory') }}" class="text-sm text-white font-medium py-2 px-2 hover:bg-red-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">Add Product to Inventory</a>
                        <a class="text-sm text-white font-medium py-2 px-2 hover:bg-red-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out" href="{{ url('inventories') }}">My Inventories</a>
                        <a href="{{ route('inventory.create') }}" class="text-sm text-white font-medium py-2 px-2 hover:bg-red-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">Create Inventory</a>
                    </div>
                </div>
            </div>
        </div>
