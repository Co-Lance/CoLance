...
<div class="flex flex-col lg:flex-row md:flex-row" style="background-color: #F6F6F6;">
            ...
            <div class="pr-16 mt-10">
                <div class="p-4">
                    <div id="menu" class="flex flex-col space-y-2">
                        <a href="{{ url('/wallets') }}" class="text-sm text-white font-medium py-2 px-2 hover:bg-red-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">Wallets</a>
                        <a href="{{ url('/addWallet') }}" class="text-sm text-white font-medium py-2 px-2 hover:bg-red-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">Add Wallet</a>
    ...
    <!-- Product Form -->
    <form action="{{ url('/storeWallet') }}" method="post" class="w-full max-w-sm">
        @csrf
        <div class="mb-4">
            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">wallet</label>
        ...
        <div class="mb-4">
            <label for="user_full_name" class="block text-gray-700 text-sm font-bold mb-2">currency</label>
        ...
        <div class="mb-4">
            <label for="quantity" class="block text-gray-700 text-sm font-bold mb-2">status:</label>
