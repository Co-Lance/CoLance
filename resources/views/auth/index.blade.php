...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                ...
                <div class="cursor-pointer flex items-center">
                        ...
                        <div  class="text-2xl text-gray-700 tracking-wide font-semibold">CoLance</div>
                    </div></a>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2 class="text-center text-4xl text-gray-800 font-display font-bold lg:text-left xl:text-5xl xl:text-bold">Log in</h2>
                    <div class="mt-12">
                        <form>
                            <div>
                            ...
                            <div class="mt-8">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div>
                                        <a class="text-xs font-display font-semibold text-teal-600 hover:text-indigo-800
                                        cursor-pointer">
                                            Forgot Password?
                                        </a>
                                    </div>
                            ...
                            <div class="mt-10">
                                <button class="bg-teal-800 text-gray-100 p-4 w-full rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-teal-900
                                shadow-lg">
                                    Log In
                                </button>
                            </div>
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Don't have an account ? <a class="cursor-pointer text-teal-800 hover:text-teal-800">Sign up</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hidden lg:flex items-center justify-center bg-gray-900 flex-1 h-screen">
    ...
    <title>Login</title>
    <rect y="17.06342" width="444" height="657" fill="#535461"/> <!-- Not changed, remains gray -->
    <polygon points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063" fill="#005151"/> <!-- Changed to teal -->
    <circle cx="296" cy="377.06342" r="4" fill="#535461"/> <!-- Not changed, remains gray -->
    <polygon points="296 377.66 298.773 382.463 301.545 387.265 296 387.265 290.455 387.265 293.227 382.463 296 377.66" fill="#535461"/> <!-- Not changed, remains gray -->
    <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#005151"/> <!-- Changed to teal -->
    <g opacity="0.1">
        <polygon points="337.217 691 317.217 691 318.217 0 337.217 0 337.217 691" fill="#fff"/> <!-- Not changed, remains gray -->
    </g>
    <circle cx="296" cy="348.06342" r="13" opacity="0.1"/> <!-- Not changed, remains gray -->
    <circle cx="296" cy="346.06342" r="13" fill="#535461"/>
                        ...
                        <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z" transform="translate(-335.6414 -100.11607)" fill="#005151"/> <!-- Changed to teal -->
                        ...
                        <path d="M820.3586,253.43948l-10.5,10.5s-32,12-47,0c0,0,5.5-11.5,5.5-10.5s-43.5,7.5-47.5,25.5,3,49,3,49-28,132-17,135,114,28,113,9,8-97,8-97l35-67s-5-22-17-29S820.3586,253.43948,820.3586,253.43948Z" transform="translate(-335.6414 -100.11607)" fill="#005151"/>
                        ...
                        <path d="M853.8586,298.93948l9,9s6,84-6,101-67,63-70,60-22-18-18-20,57.18287-57.56942,57.18287-57.56942l-4.18287-77.43058Z" transform="translate(-335.6414 -100.11607)" fill="#005151"/>
