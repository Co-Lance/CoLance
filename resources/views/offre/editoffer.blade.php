            ...
            <div class="pr-16 mt-10">
                <div class="p-4">
                    <div id="menu" class="flex flex-col space-y-2">
                        ...
                        <a  class="text-sm text-white font-medium py-2 px-2 hover:bg-red-700 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out" href="{{route('createoffre')}}">Create Offer</a>
                    ...
                    <div class="flex justify-center   ">
                        ...
                        <div class="w-screen xl:w-3/4 lg:w-11/12 flex">
                            ...
                            <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
                                ...
                                <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" action="{{route('offers.put',['id' => $offre->id])}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-4 ">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input value="{{$offre->image}}" type="text" name="image" id="image" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                        </div>
                                    </div>
                                    <div class="mb-4">
