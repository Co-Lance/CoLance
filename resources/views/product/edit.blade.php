...
<div class="flex flex-col lg:flex-row md:flex-row" style="background-color: #F6F6F6;">
    ...
    <div class="flex flex-col overflow-y-auto flex-grow" style="height:100vh;">
        ...
        <div class="flex flex-col flex-grow p-4 items-center ">
          ...
          <!-- Edit Product Form -->
<form action="{{ route('products.update', ['id' => $product->id]) }}" method="post" class="w-full max-w-sm">
    @csrf
    ...
    <div class="mb-4">
        ...
        <input type="text" name="user_full_name" id="user_full_name" value="{{ $product->user_full_name }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
    </div>
    <div class="mb-4">
    ...
    <div class="mb-4">
        ...
        <textarea name="description" id="description" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>{{ $product->description }}</textarea>
    </div>
